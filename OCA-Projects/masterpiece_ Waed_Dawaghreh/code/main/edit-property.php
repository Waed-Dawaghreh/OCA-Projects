                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        <div class="single-add-property">
                         ...
                         $query=" SELECT * FROM property WHERE property_id=$p_id AND user_id=$u_id"; 
...
$property_rooms=$row['property_name'];
...
$sql="SELECT city_name AS city From city WHERE city_id  = ".$row["city_id"]." "; 
                         ...
                         ?> 
                            <h3>Edit Property [ <?php echo $property_name; ?> ]</h3>
                            <div class="property-form-group">
                                <form action="php/update-property.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    <div class="row">
                                        
                                        <div class="col-md-12">
                                            <p>
                                                <label for="title">Property Title</label>
                                                <input type="text" name="pro-name"  id="title" value="<?php echo $property_name;?>" required >
                                                <input type="hidden" name="pro-id"  id="title" value="<?php echo $p_id;?>" required >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <textarea id="description" name="pro-desc" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12">
                                               ...
                                               <label > Status </label>
                                            <select  name="pro-status"  class="nice-select form-control wide" placeholder='sdasd' tabindex="0" required >
                                                    <option value="<?php echo $property_status;?>" selected='selected' class="option selected ">Current [ For <?php echo $property_status;?>  ] </option>
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <select  name="pro-type"  class="nice-select form-control wide" tabindex="0" required >
                                                    <option value="<?php echo $property_type;?>" selected='selected' class="option selected ">Current [ <?php echo $property_type;?>  ] </option>
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                               ...
                                               <label for="bedrooms" > Bedrooms </label>
                                                <select name="pro-bedrooms"  class="nice-select form-control wide" tabindex="0" required>
                                                    <option value="<?php echo $property_bedrooms;?>" selected='selected' class="option selected ">Current [ <?php echo $property_bedrooms;?>  ] </option>
                                             ...
                                             <div class="col-lg-4 col-md-12">
                                               ...
                                               <label > Bathrooms </label>
                                                <select name="pro-bathrooms"  class="nice-select form-control wide" tabindex="0" required>
                                                    <option value="<?php echo $property_bathrooms;?>" selected='selected' class="option selected ">Current [ <?php echo $property_bathrooms;?>  ] </option>
                                                    <option value="1" class="option selected ">1</option>
                                                    <option value="2" class="option selected ">2</option>
                                                    <option value="3" class="option selected ">3</option>
                                                    <option value="4" class="option selected ">4</option>
                                            ...
                                            <select  name="pro-city"  class="nice-select form-control wide" tabindex="0" required>
                                                    <option value="<?php echo $city_id;?>" selected='selected' class="option selected ">Current [ <?php echo $city;?>  ] </option>
                                    ...
                                    <div class="row">
                                            ...
                                            <input type="text" name="pro-address" value="<?php echo $address;?>" id="address" required>
                                              </p>
                                           </div>
                                   <div class="col-lg-6 col-md-12">
                                        <p class="no-mb first">
                                            <label for="latitude">Google Maps latitude</label>
                                            <input type="text" name="pro-latitude" value="<?php echo $latitude;?>"  id="latitude" required>
                                        </p>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <p class="no-mb last">
                                            <label for="longitude">Google Maps longitude</label>
                                            <input type="text" name="pro-longitude" value="<?php echo $longitude;?>" id="longitude" required>
                                        </p>
                                    </div>
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb">
                                                <label for="price">Price</label>
                                                <input type="text" name="pro-price" value="<?php echo $property_price;?>"id="price" required>
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last">
                                                <label for="area">Area</label>
                                                <input type="text" name="pro-area" value="<?php echo $property_area_size;?>" id="area" required>
                                            </p>
                                        </div>
                                           <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last">
                                                <label for="area">Building Age</label>
                                                <input type="number" name="pro-age" value="<?php echo $building_age;?>" required>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-elemts">
                                            <button type="submit" name="edit-pro-submit">Save Changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(function(){
            $("button[type = 'submit']").click(function(){
               ...
               if (parseInt($fileUpload.get(0).files.length) > 5){
                   if(!alert('You are only allowed to upload a maximum of 5 files')){window.location.reload();}
               }
            });
         });
            $(".dropzone").dropzone({
