                ...
                <div class="container container-header">
                    ...
                    <div class="header-user-menu user-menu add">
                        <div class="header-user-name">
                            <span><img src="images/testimonials/ts-1.jpg" alt=""></span><?php if (isset($_SESSION['auth'])) {
                ...
                <div class="row">
                    ...
                    if (!empty($_GET['property'])) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            $sql = "SELECT city_name AS city From city WHERE city_id  = '$city' ";
                            $r = mysqli_query($conn, $sql);
                        ...
                        <div class="row m0">
                            <div class="col-lg-12 p0">
                                <div class="popup-images">
                                    <a class="popup-img" href="php/uploads/<?php foreach ($images[0] as $data) {
                                                                                echo $data;
                                                                            } ?>"><img class="img-fluid w100" src="php/uploads/<?php foreach ($images[0] as $data) {
                                                                                                                                    echo $data;
                                                                                                                                } ?>" alt=""></a>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-6 p0">
                        <div class="row m0">
                            <div class="col-sm-6 col-lg-6 p0">
                                <div class="popup-images">
                                    <a class="popup-img" href="php/uploads/<?php foreach ($images[1] as $data) {
                                                                                echo $data;
                                                                            } ?>"><img class="img-fluid w100" src="php/uploads/<?php foreach ($images[1] as $data) {
                                                                                                                                    echo $data;
                                                                                                                                } ?>" alt=""></a>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 p0">
                                <div class="popup-images">
                                    <a class="popup-img" href="php/uploads/<?php foreach ($images[2] as $data) {
                                                                                echo $data;
                                                                            } ?>"><img class="img-fluid w100" src="php/uploads/<?php foreach ($images[2] as $data) {
                                                                                                                                    echo $data;
                                                                                                                                } ?>" alt=""></a>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 p0">
                                <div class="popup-images">
                                    <a class="popup-img" href="php/uploads/<?php foreach ($images[3] as $data) {
                                                                                echo $data;
                                                                            } ?>"><img class="img-fluid w100" src="php/uploads/<?php foreach ($images[3] as $data) {
                                                                                                                                    echo $data;
                                                                                                                                } ?>" alt=""></a>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 p0">
                                <div class="popup-images">
                                    <a class="popup-img" href="php/uploads/<?php foreach ($images[4] as $data) {
                                                                                echo $data;
                                                                            } ?>"><img class="img-fluid w100" src="php/uploads/<?php foreach ($images[4] as $data) {
                                                                                                                                    echo $data;
                                                                                                                                } ?>" alt=""></a>
                                </div>
                            </div>
